...
<img src="https://static01.nyt.com/images/2020/01/01/business/01Techfix-print/01Techfix-print-articleLarge.gif?quality=75&auto=webp&disable=upscale" width="100%" style="max-width: 320px;" />
...
<table border="0" width="100%">
  <tr>
    <td width="50%" valign="top">
      <h3>🌍 Itinera – Travel Planner</h3>
      <p><i>Python, Streamlit, Pandas</i></p>
      <ul>
        <li>Interactive travel application generating customized day-wise itineraries.</li>
        <li>Features location filtering, budget awareness, and structured itinerary downloads.</li>
      </ul>
      <p>
        <a href="https://github.com/Arushi28-hub/AI_TRAVEL_PLANNER"><img src="https://img.shields.io/badge/GitHub-Repo-blue?style=flat-square&logo=github"/></a>
        <a href="https://aitravelplanner-izieymnkqpa22ffrmecsvv.streamlit.app/"><img src="https://img.shields.io/badge/Live-Demo-red?style=flat-square&logo=streamlit"/></a>
      </p>
    </td>
    <td width="50%" valign="top">
      <h3>🤟 SignAloud – Gesture Translation System</h3>
      <p><i>Python, OpenCV, Streamlit</i></p>
      <ul>
        <li>Real-time sign language recognition interface converting gesture input into audio output.</li>
        <li>Built an accessible web interface designed for seamless real-time interaction.</li>
      </ul>
      <p>
        <a href="https://github.com/Arushi28-hub"><img src="https://img.shields.io/badge/GitHub-Repo-blue?style=flat-square&logo=github"/></a>
      </p>
    </td>
  </tr>
</table>
...
<img src="https://samdev-pulse.vercel.app/api/profile?username=Arushi28-hub&theme=midnightneon&leetcode=Arushi_45" width="100%" style="max-width: 850px;" />
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:E9D5FF,100:8B5CF6&height=120&section=footer" width="100%" />
